...
public class ViewVaccantHouses implements Controller, Initializable {
    ...
    public void goBack() throws Exception {
        tblVaccantHouses.getScene().setRoot(new Dashboard().getContent());
    }
}
