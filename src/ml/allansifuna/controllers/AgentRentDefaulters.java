...
public class AgentRentDefaulters implements Controller, Initializable {
    @FXML
    ...
    String defaultedRents="select house.houseNumber, tenant.firstName,tenant.lastName ,r.balance,agent.firstName,agent.lastName from house " +
            ...
            " and r.date> ? and agent.id=?";
    public Parent getContent() throws Exception{
        return FXMLLoader.load(AddAgent.class.getResource("/ml/allansifuna/fxmls/AgentRentDefaulters.fxml"));
    }
    public void goBack() throws Exception {
        tblRentDefaulters.getScene().setRoot(new AgentDashboard().getContent());
    }
